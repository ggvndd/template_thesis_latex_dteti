...
\author{Gavind Muhammad Pramahita}{22/497221/TK/54484}
% Input the thesis' title
\title{Adaptive UI/UX Design of a Mood Tracker App with Chatbot Support for Mental Health of Non-Traditional Workers}
% Program and the head of the program
\program{Teknologi Informasi}{Ir. Agus Bejo}{<<NIP>>}
% Name of department head and NIP
\departmenthead{Hanung Adi Nugroho}{<<NIP>>}
...
\usepackage{array}    % advanced column types (>{\raggedright\arraybackslash}p{})
